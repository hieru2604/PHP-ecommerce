    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><strong><i class="fas fa-book-open" style="margin-right: 14px;"></i>UMI</strong></a>
				<div id="sideNav" href="">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="index.php?controller=customers"><i class="fa fa-user"></i>List customers</a>
                    </li>	
                    <li>
