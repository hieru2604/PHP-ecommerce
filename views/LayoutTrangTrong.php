...
<head>
    <title>UMI-Mua mô hình trực tuyến giá rẻ nhất</title>
    <meta name="description"
        content="Mua mô hình online tốt, giá tốt nhất, combo hot bán chạy, giảm giá cực khủng cùng với những ưu đãi như miễn phí giao hàng, quà tặng miễn phí, đổi trả nhanh chóng. Đa dạng sản phẩm, đáp ứng mọi nhu cầu.">
    <meta name="keywords" content="Cửa hàng online, mua mô hình tốt, mô hình hot, mô hình bán chạy, giảm giá nhiều">
    <meta charset="UTF-8">
...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v11.0" nonce="6ZXTskPM"></script>
    ...
    <nav class="navbar navbar-expand-md bg-white navbar-light">
        <div class="container">
            <!-- logo  -->
            <a class="navbar-brand" href="index.php" style="color: #CF111A;"><b>UMI</b>.com</a>
            <!-- navbar-toggler  -->
            ...
            <form class="form-inline ml-auto my-2 my-lg-0 mr-3">
                <div class="input-group" style="width: 520px;" style="position: relative;">
                    <input type="text" autocomplete="off" class="form-control" id="key" aria-label="Small"
                        placeholder="Nhập tên mô hình cần tìm...">
