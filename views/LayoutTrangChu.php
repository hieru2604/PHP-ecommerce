            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="dichvu d-flex align-items-center">
                        ...
                        <div class="noidung">
                            <h3 class="tieude font-weight-bold">HƠN 1000 mô hình khác nhau</h3>
                            <p class="detail">Tuyển chọn bởi UMI</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="dichvu d-flex align-items-center">
                        ...
                        <div class="noidung">
                            ...
                            <p class="detail">Tặng móc khóa</p>
                            <p class="detail">Poster miễn phí</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
        ...
        <div class="container py-4">
            <div class="row">
                <div class="col-md-3 col-xs-6">
                    <div class="gioithieu">
                        <h3 class="header text-uppercase font-weight-bold">Về UMI</h3>
                        <a href="#">Giới thiệu về UMI</a>
                        <a href="#">Tuyển dụng</a>
